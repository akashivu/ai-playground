...
async def destination_info_workflow(state: dict) -> dict:
    ...
    return {
        ...
        "metadata": {
            ...
            "places": {
                "attractions": [p.model_dump() for p in details.attractions],
                "restaurants": [p.model_dump() for p in details.restaurants],
                "activities": [p.model_dump() for p in details.activities],
            },
        },
    }