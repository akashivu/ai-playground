...
from langchain_components.graph.multi_step_agent_nodes.tool_routing import route_tool_calls
...
graph_builder.add_conditional_edges("agent", route_tool_calls)
graph_builder.add_edge("tool", "agent")

multi_step_agent_graph = graph_builder.compile()